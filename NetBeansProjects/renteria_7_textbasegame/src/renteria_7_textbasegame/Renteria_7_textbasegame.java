...
public class Renteria_7_textbasegame {
    ...
    public static void main(String[] args) {
        ...
        while (no & !eg & !eal) {
            ...
            if (problem2.contains("look")) {
                no = true;
                System.out.println("you look but where unsucsessful ");
            }
            if (problem2.contains("steal")) {
                no = false;
                eal = true;

            }
            if (problem2.contains("beg")) {
                no = false;
                eg = true;
            ...
            while (j & !erk & !ait & !elo) {
                ...
                while ( ait & !j ) {
                    ...
                    System.out.println("you wake up it was all a dream you are still at the hotel");
